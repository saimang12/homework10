            ...
            <div class="gnb_bar">
                <nav class="gnb">
                    <ul>
                        ...
                        <li>
                            <a href="/bbs/board.php?bo_table=notice">땅스소식</a>
                            <ul class="s_menu">
                                <li><a href="/bbs/board.php?bo_table=notice">뉴스 및 공지</a></li>
                                <li><a href="/bbs/board.php?bo_table=event">이벤트 및 소식</a></li>
                                <li><a href="">우수·모범가맹점</a></li>
                                <li><a href="">땅스TV</a></li>
                                <li><a href="">캐릭터</a></li>
                            </ul>
                        </li>
