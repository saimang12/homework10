            ...
            <div class="gnb_bar">
                <nav class="gnb">
                    <ul>
                        ...
                        <li>
                            <a href="<?= G5_THEME_URL?>/doc/m04-01.php">메뉴</a>
                            <ul class="s_menu">
                                <li><a href="<?= G5_THEME_URL?>/doc/m04-01.php">땅스부대찌개</a></li>
                                <li><a href="">푸담소곱창전골</a></li>
                                <li><a href="">땅스떡볶이</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?= G5_THEME_URL?>/doc/m05-01.php">매장찾기</a>
                            <ul class="s_menu">
                                <li><a href="<?= G5_THEME_URL?>/doc/m05-01.php">국내 매장찾기</a></li>
                                <li><a href="">해외 매장찾기</a></li>
                                <li><a href="">신규매장</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?= G5_THEME_URL?>/doc/m06-01.php">땅스오더</a>
                            <ul class="s_menu">
                                <li><a href="<?= G5_THEME_URL?>/doc/m06-01.php">앱 다운로드</a></li>
